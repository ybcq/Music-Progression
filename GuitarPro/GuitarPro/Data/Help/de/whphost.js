	...
	if(gnChecked==0||isSamePath(gaProj[gnChecked].sPPath,aRProj[0].sPPath))
	{
		if(gnChecked!=0)
		{
			if(aRProj[0].sLangId!=gaProj[0].sLangId)
				alert("Das zusammengef&uuml;hrte Hilfesystem "+aRProj[0].sPPath+" verwendet eine andere Sprache als das Haupthilfesystem. Dies f&uuml;hrt dazu, dass der Index und die Volltextsuche im zusammengef&uuml;hrten Hilfesystem deaktiviert werden.");
		}
