...
var gsTBSelectedBgColor="#888888";
...
function writeStyle(bMiniBar)
{
	...
	sStyle+=".clsNoBNormal {\n";
	sStyle+="padding-left:0px;padding-right:0px;\n";
	sStyle+="cursor:hand;\n";
	sStyle+="font-family:"+gsTBFontFamily+";\n";
	sStyle+="font-size:"+gsTBFontSize+";\n";
	sStyle+="color:"+gsTBFontColor+";}\n";
	...
	sStyle+="padding-left:0px;padding-right:2px;\n";
	sStyle+="cursor:default;\n";
	sStyle+="font-family:"+gsTBFontFamily+";\n";
	sStyle+="font-size:"+gsTBFontSize+";\n";
	sStyle+="color:"+gsTBFontColor+";}\n";
	...
	if(!(gbNav4&&!gbNav6))
		if (bMiniBar)
			...
			sStyle+="padding:5px;\n";
	sStyle+="border-bottom:"+gsTBDarkColor+" 0px solid;\n";
	sStyle+="border-left:"+gsTBLightColor+" 0px solid;\n";
	sStyle+="border-right:"+gsTBDarkColor+" 0px solid;\n";
	sStyle+="border-top:"+gsTBLightColor+" 0px solid;\n";
	sStyle+="cursor:hand;";
	sStyle+="font-family:"+gsTBFontFamily+";\n";
	sStyle+="font-size:"+gsTBFontSize+";\n";
	sStyle+="color:"+gsTBFontColor+";}\n";
	...
	if(!(gbNav4&&!gbNav6))
		if (bMiniBar)
			...
			sStyle+="padding:5px;\n";
	sStyle+="border-bottom:"+gsTBLightColor+" 0px solid;\n";
	sStyle+="border-left:"+gsTBDarkColor+" 0px solid;\n";
	sStyle+="border-right:"+gsTBLightColor+" 0px solid;\n";
	sStyle+="border-top:"+gsTBDarkColor+" 0px solid;\n";
	sStyle+="color:"+gsTBFontColor+";\n";
	sStyle+="cursor:hand;\n";
	sStyle+="font-family:"+gsTBFontFamily+";\n";
	sStyle+="font-size:"+gsTBFontSize+";}\n";
...
function addButton(sType,nStyle,sTitle,sHref,sOnClick,sOnMouseOver,sOnLoad,nWidth,nHeight,sI1,sI2,sI3,sI4,sI5,sI6)
{
	...
	{
		var svTitle="Sujet pr&eacute;c&eacute;dent";
