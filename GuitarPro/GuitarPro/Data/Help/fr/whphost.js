	...
	if(gnChecked==0||isSamePath(gaProj[gnChecked].sPPath,aRProj[0].sPPath))
	{
		if(gnChecked!=0)
		{
			if(aRProj[0].sLangId!=gaProj[0].sLangId)
				alert("Le système d'aide fusionn&eacute; "+aRProj[0].sPPath+" utilise une langue diff&eacute;rente de celle du système d'aide maître. Les fonctionnalit&eacute;s d'index et de recherche sur le texte int&eacute;gral vont être d&eacute;sactiv&eacute;es dans le système d'aide fusionn&eacute;.");
		}
